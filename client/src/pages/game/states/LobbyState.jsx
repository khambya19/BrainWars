  ...
  return (
    <div className="mx-auto max-w-xl">
      <div className="animate-fade-in-up mb-6 text-center">
        ...
        <div
          className="mx-auto mb-2 cursor-pointer font-['Orbitron'] text-[4rem] leading-none tracking-[0.12em] text-[#EDEFF5] transition hover:text-pink-400"
          onClick={copyCode}
          title="Click to copy"
        >
          {room.code}
      ...
      <div className="animate-fade-in-up mb-6 rounded-2xl border border-pink-500/15 bg-[#141B2E]/85 p-5" style={{ animationDelay: '100ms' }}>
        ...
        <ul className="grid gap-2">
          {room.players.map((p) => (
            <li key={p.playerId} className="flex items-center gap-3">
              ...
              <span className="text-sm text-[#EDEFF5]">
                {p.name}
